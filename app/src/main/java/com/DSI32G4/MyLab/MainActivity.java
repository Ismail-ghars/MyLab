...
//        GoogleSignInClient mGoogleSignInClient = GoogleSignIn.getClient(this,gso);
    ...
    public void onClick(View v){
        Intent noPass = new Intent(getApplicationContext(),MotDePasseOublie.class);
        startActivity(noPass);
    }
...
//            @Override
//            public void onClick(View v) {
//                Intent pass = new Intent(getApplicationContext(),MotDePasseOublie.class);
//                startActivity(pass);
//
//            }
//        });
